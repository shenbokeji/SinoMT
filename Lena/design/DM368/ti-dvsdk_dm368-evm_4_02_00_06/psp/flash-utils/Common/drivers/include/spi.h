...
extern void SPI_open(Uint32 spiPeripheralNum, SPI_Role role, SPI_Mode mode, SPI_Config *config);
extern Uint32 SPI_reset();
//extern Uint32 SPI_readBytes(Uint32 byteCnt, Uint8 *dest);
//extern Uint32 SPI_writeBytes( Uint32 byteCnt, Uint8 *src);
extern Uint32 SPI_xferOneChar(Uint32 dataOut);
