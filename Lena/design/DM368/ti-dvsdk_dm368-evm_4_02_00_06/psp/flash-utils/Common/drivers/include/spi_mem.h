...
extern void SPI_MEM_open(Uint32 spiPeripheralNum);
extern Uint32 SPI_MEM_readBytes(Uint32 spi_id, Uint32 addr, Uint32 byteCnt, Uint8 *dest);
extern Uint32 SPI_MEM_writeBytes(Uint32 spi_id, Uint32 addr, Uint32 byteCnt, Uint8 *src);
