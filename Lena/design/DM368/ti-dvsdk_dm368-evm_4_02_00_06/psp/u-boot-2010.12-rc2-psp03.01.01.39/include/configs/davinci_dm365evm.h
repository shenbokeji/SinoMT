...
#define CONFIG_ENV_SECT_SIZE    CFG_ENV_SECT_SIZE
#define CONFIG_ENV_SIZE		0x2000
#define CFG_ENV_SIZE		0x40000
#define CFG_MALLOC_LEN		(CFG_ENV_SIZE + (16*1024 * 1024))
#define CFG_ENV_OFFSET		(19 * CFG_ENV_SECT_SIZE)
